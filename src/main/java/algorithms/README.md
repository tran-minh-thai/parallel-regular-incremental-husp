...
| `AdaptiveBuffer.java` | Buffer threshold θ = μ·δ·U(D_old). Fixed at μ = 1 for the proposed miner; the adaptive strategies remain only to drive the baselines | Buffer factor discussion |
